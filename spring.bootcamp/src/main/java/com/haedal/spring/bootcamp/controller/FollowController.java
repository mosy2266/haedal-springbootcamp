...
public class FollowController {
    ...
    public ResponseEntity<Void> followUser(@PathVariable("followingId") Long followingId, HttpServletRequest request) {
    ...
    public ResponseEntity<Void> unfollowUser(@PathVariable("followingId") Long followingId, HttpServletRequest request) {
        User currentUser = authService.getCurrentUser(request);
    ...
    public ResponseEntity<List<UserSimpleResponseDto>> getFollowingUsers(@PathVariable("userId") Long userId,
    ...
    public ResponseEntity<List<UserSimpleResponseDto>> getFollowerUsers(@PathVariable("userId") Long userId,
                                                                        HttpServletRequest request) {
        User currentUser = authService.getCurrentUser(request);
